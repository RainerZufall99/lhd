                        ...
                        {!lastQuestionRef.current ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Fragen Sie mich etwas!</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Ich beantworte Ihnen alle Fragen zu den 50 beliebtesten Dienstleistungen in der Landeshauptstadt Düsseldorf!</h2>
                            </Stack>
                        ) : (
